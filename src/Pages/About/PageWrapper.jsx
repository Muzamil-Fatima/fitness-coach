      ...
      <div className="grid grid-cols-2 gap-4 mt-8 mb-12">
        <div className="">
           <div className="mb-8"><DropDown /></div> 
            <span className="font-secondary text-[64px] font-semibold uppercase">1 HOUR</span>
            <h4 className="font-secondary font-medium text-2xl uppercase mt-8 mb-8">LOCATION: IN PERSON (DUBAI)</h4>
        ...
        <div>
            <img src={image1} alt={title1+title2} className="w-[555px] h-[397px] m-4" />
            <img src={image2} alt={title1+title2} className="w-[576px] h-[304px] m-4" />
        </div>
        <BookNow />
      </div>
      <div className="m-20">
